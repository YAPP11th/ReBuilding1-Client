...
public class CustomCalendar extends CaldroidFragment {
    ...
    protected void refreshMonthTitleTextView() {
        ...
        String monthTitle = DateUtils.formatDateRange(getActivity(),
                monthYearFormatter, millis, millis, MONTH_YEAR_FLAG).toString().toUpperCase(Locale.getDefault());

        StringTokenizer st = new StringTokenizer(monthTitle);
        yearTitleTextView.setText("" + st.nextToken());
        monthTitleTextView.setText("" + st.nextToken());
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = localInflater.inflate(R.layout.calendar_header, container, false);

        // For the year / monthTitleTextView

        yearTitleTextView = (TextView) view
                .findViewById(R.id.calendar_year_textview);
